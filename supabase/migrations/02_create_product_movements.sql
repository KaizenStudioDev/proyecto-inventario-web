...
-- Execute this in Supabase SQL Editor AFTER running migration 01

-- Create product_movements table (compatible with existing stock_movements)
...
-- Allow admin to insert movements (you'll need to adjust role check based on your profiles table)
