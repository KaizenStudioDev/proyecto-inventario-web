...
export default function LandingPage() {
    ...
    const handleDemoLaunch = async (tier) => {
        ...
        try {
            ...
            toast.success(`Entering ${tier} demo...`);
        ...
        <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-200 relative">
            ...
            {isLoggingIn && (
                <div className="fixed inset-0 z-[100] bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm flex flex-col items-center justify-center animate-fade-in">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Connecting to secure sandbox...</p>
                </div>
            )}
            ...
            <section className="relative pt-20 pb-32 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 lg:px-6 relative z-10 text-center">
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white tracking-tight mb-6">
                        ...
                        <span className="text-gray-400 dark:text-gray-500">for Modern Business</span>
                    </h1>
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
                        Stop managing inventory in spreadsheets. Upgrade to a professional system that scales with your growth, from simple stock tracking to enterprise operational flows.
                    </p>
            ...
            <section id="products" className="py-24 bg-gray-50 dark:bg-gray-900/50">
                <div className="max-w-7xl mx-auto px-4 lg:px-6">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Choose your operational level</h2>
                        <p className="text-gray-600 dark:text-gray-400">Select the module that fits your current stage. Upgrade anytime instantly.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-xl transition-all duration-300 group">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Inventory Basic</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">For startups needing strict stock control.</p>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-green-500">✓</span> Real-time Stock Tracking
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-green-500">✓</span> Low Stock Alerts
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-green-500">✓</span> Product Catalog
                                </li>
                            </ul>
                            <button
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-blue-200 dark:border-blue-900/50 shadow-lg relative overflow-hidden group">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Inventory + Sales</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">For growing retailers managing customers.</p>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-blue-500">✓</span> Everything in Basic
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-blue-500">✓</span> Customer Database
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-blue-500">✓</span> Sales & Invoicing
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-blue-500">✓</span> Performance Reports
                                </li>
                            </ul>
                            <button
                                onClick={() => handleDemoLaunch('sales')}
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-700 hover:shadow-xl transition-all duration-300 group">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Enterprise Suite</h3>
                            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Complete control for established businesses.</p>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-purple-500">✓</span> Everything in Sales
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-purple-500">✓</span> Supplier Management
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                    <span className="text-purple-500">✓</span> Purchase Orders
                                </li>
                                <li className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
            ...
            <section id="features" className="py-24">
                <div className="max-w-7xl mx-auto px-4 lg:px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Built for speed, <br />designed for control.</h2>
                            <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">
                                We removed the clutter found in traditional ERPs. Opero focuses on the daily workflows that actually matter to your team.
                            </p>
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Instant Search</h4>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Find any SKU, customer, or transaction in milliseconds with our indexed search engine.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Role-Based Security</h4>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Granular permissions ensure staff only see what they need. Sales can't edit stock; Accountants can't delete users.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-gray-900 dark:text-white">Data Integrity</h4>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Every movement is audited. Stock levels are protected by database constraints, preventing negative inventory.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
